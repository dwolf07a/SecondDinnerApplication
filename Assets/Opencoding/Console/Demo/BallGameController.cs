...
namespace Opencoding.Console.Demo
{
	class BallGameController : MonoBehaviour
	{
		...
		[SerializeField] private BallSpawner[] _ballSpawners = null;
		[SerializeField] private BallGameGameOverUI _gameOverUI = null;
		[SerializeField] private BallGameHUD _hud = null;
