...
namespace Opencoding.Console.Editor
{
	...
	public class DetectUpgrade
	{
		...
		private static void ShowDeleteMessage()
		{
			...
			if (Directory.Exists("Assets/Opencoding/DLLs"))
			{
				EditorUtility.DisplayDialog("Important TouchConsole Pro Upgrade Information",
					"This version of TouchConsole Pro moves the code from DLLs into the project.\n\nThis upgrade process will delete the DLLs from your project.",
					"Ok");
				AssetDatabase.DeleteAsset("Assets/Opencoding/DLLs");
