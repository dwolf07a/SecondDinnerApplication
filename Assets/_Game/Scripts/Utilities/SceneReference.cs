...
public class SceneReferencePropertyDrawer : PropertyDrawer
{
    ...
    const string sceneAssetPropertyString = "_sceneAsset";
    // The exact name of  the scene Path variable in the SceneReference object
    const string scenePathPropertyString = "_scenePath";

    private static RectOffset _boxPadding;

    // Use this property instead of the field in your drawing code
    private static RectOffset boxPadding
    {
        get
        {
            if (_boxPadding == null)
            {
                _boxPadding = EditorStyles.helpBox.padding;
            }
            return _boxPadding;
        }
    }
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (EditorGUI.EndChangeCheck())
        {
            ...
            if (buildScene._scene == null)
                GetScenePathProperty(property).stringValue = string.Empty;
        }
        position.y += paddedLine;

        if (buildScene._assetGUID.Empty() == false)
        {
    ...
    private void DrawSceneInfoGUI(Rect position, BuildUtils.BuildScene buildScene, int sceneControlID)
    {
        ...
        {
            iconContent = EditorGUIUtility.IconContent("Assets/Editor Default Resources/Icons/d_winbtn_mac_close.png");
        ...
        {
            iconContent = EditorGUIUtility.IconContent("Assets/Editor Default Resources/Icons/d_winbtn_mac_max.png");
        ...
        {
            iconContent = EditorGUIUtility.IconContent("Assets/Editor Default Resources/Icons/d_winbtn_mac_min.png");
            labelContent.text = "BuildIndex: " + buildScene._buildIndex;
        ...
        using (new EditorGUI.DisabledScope(readOnly))
        {
            ...
            {
                bool isEnabled = buildScene._scene.enabled;
    ...
    static private class BuildUtils
    {
        ...
        static public BuildScene GetBuildScene(Object sceneObject)
        {
            ...
            {
                if (entry._assetGUID.Equals(EditorBuildSettings.scenes[index].guid))
                {
                    entry._scene = EditorBuildSettings.scenes[index];
        ...
        static public void SetBuildSceneState(BuildScene buildScene, bool enabled)
        {
            ...
            {
                if (curScene.guid.Equals(buildScene._assetGUID))
                {
        ...
        static public void AddBuildScene(BuildScene buildScene, bool force = false, bool enabled = true)
        {
            ...
            EditorBuildSettingsScene newScene = new EditorBuildSettingsScene(buildScene._assetGUID, enabled);
        ...
        static public void RemoveBuildScene(BuildScene buildScene, bool force = false)
        {
            ...
            if (force == false)
            {
                ...
                string details = string.Format("You are about to remove the following scene from build settings:\n    {0}\n    buildIndex: {1}\n\n{2}",
                                buildScene._assetPath, buildScene._buildIndex,
